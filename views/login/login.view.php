...
<body>
	<div class="login-register" style="background-image:url(http://localhost/www/CofeeGarden/public/img/background/fondo-login-1024x427.jpg);">
					...
					<div class="card card-login">
						...
						<div class="card-header">
							<div class="justify-content-center row">
								...
								<div class="col-6">
									<img src="public/img/Coffe Garden.png" alt="" class="img-fluid shadow-lg p-3">
								</div>
							</div>
							<!-- <hr> -->
						</div>
									...
									<form id="create_account" style="display:none">
										<div id="register_user" class="animate form registration_form">
											<section class="login_content">
												...
												<div class="form-group">
													<input type="password" class="form-control" placeholder="Contrase&ntilde;a" required id="password_verify" />
												</div>
