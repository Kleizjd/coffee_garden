                ...
                <div class="row">
                    <div class="col-sm">
                        ...
                        <div class="row pb-3">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" id="codigo_producto" name = "codigo_producto" value="<?=$product["Code_Product"];?>" readonly >
                            </div>
                            <div class="col-sm-1">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" name="valor" value="<?=$product["Price"];?>">
                            </div>
                            <div class="col-sm-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <textarea rows="4" cols="4" class="form-control" id="descripcion" name="descripcion" ><?=$product["Description"];?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready( function(){
    $(function editarProduct() {
		$(document).on("submit", "#form_EditProduct", function (event) {
			...
			formData.append("funcion", "editarProduct");
			$.ajax({
