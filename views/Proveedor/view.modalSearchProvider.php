...
<script>
	...
	$(function verProveedor() {
		$(document).on("click", "#verProveedor", function () {
			...
			llamarVista("Provider", "Provider", "verProveedor", {nit_provider: data.nit_provider}, true);
		});
	});
	...
	$(function editarProveedor() {
		$(document).on("click", "#editarProveedor", function () {
			let data = $("#tableModalSearchProvider").DataTable().row($(this).parents("tr")).data();
			llamarVista("Provider", "Provider", "editarProveedor", {nit_provider: data.nit_provider}, true);
		});
	});
