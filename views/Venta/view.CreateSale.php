			...
			<div class="modal-body">
                <form id="form_ValidateCostumer" action="">
                    <div class="row pt-1">
                        ...
                        <div class="col-sm-4"><button type="submit" class="btn btn-primary" placeholder="Ingrese su cedula" name="idCostumer" id="idCostumer">
            ...
            var tableAddProduct = $("#tableAddProduct").DataTable({
                ...
                initComplete: () => {
                            ...
                            if(product!="" && amount!="" ){
                                    ...
                                    if (error == false) {
                                        tableAddProduct.row.add([
                                                ...
                                                '<input type="text" name="valor[]" class="text-center form-control" value="' +valor+ '" readonly>',
                                                importe,
                    ...
                    $("#form_Sale").on("submit", function (event) { 
                        ...
                        formData.append("funcion", "generarVenta");
