...
-- Volcando datos para la tabla coffee_garden.producto: ~21 rows (aproximadamente)
...
-- Volcando estructura para tabla coffee_garden.rol_usuario
CREATE TABLE IF NOT EXISTS `rol_usuario` (
  `id` int(150) NOT NULL,
  `rol` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla coffee_garden.rol_usuario: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla coffee_garden.usuarios: 15 rows
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `apellido`, `password`, `email`, `estado_usuario`, `rolid`, `imagen_usuario`) VALUES
	(1, '   José Daniel', '   Grijalba', '$2y$10$An1ghzpGGYth9vnvA6CHveNqNWNqLtBDzMv.QOLhaIZkpeZsYR6HC', 'jose.jdgo97@gmail.com', 'A', 1, '2-1.jpg'),
	(2, 'Juan David', 'Grijalba', '1107509520', 'juandgo1997@gmail.com', 'A', 2, ''),
	(3, 'mario', ' 123', '123', '', 'A', 2, ''),
	...
	(6, 'mario', ' 123', '$2y$10$zOYYqMdOEzFAw1D4vz/jZ.EaEcB.3nsH8TzlU47oow9QI/SSp004e', '', 'A', 2, ''),
	(7, 'Camilo', 'Delgado', '$2y$10$dmDf1V0Ib2b2bw1g7R3QtuGHnOEBQx14RkDS3bXHUy6tkJPDDGBr6', 'camilo@mail.com', 'A', 2, '6-89.jpg'),
	(8, 'mario', ' 123', '$2y$10$ihy5RzyLszHudOUR7QzjOuM.3XAO2de9FJiZi1umVLQH9ZR5LaIrC', '', 'A', 2, ''),
	(9, 'mario', ' 123', '$2y$10$Cp9Bi912X6jdEWavWT0M8uX0CUHeNPql7JUu4ZwL.r4MBcEyDnXEi', '', 'A', 2, ''),
	(10, 'mario', ' 123', '$2y$10$KcGFFtuKnY6IMGVm4tGEEuZ3WsgvwBT/kJlSrrRJaYd9oR.MIUPMG', '', 'A', 2, ''),
	(11, 'mario', ' 123', '$2y$10$aH7rl.arBduDKsr9yPm4AeTX4RKBULIEal1c.UWlVVrfeKs2f5Wlu', '', 'A', 2, ''),
	...
	(17, 'luis', 'garces', '$2y$10$mGIpInBVNSK3jeuSW23b3.iJuPvpRt259TWLKZYTKQ/lYKozA9/Ty', 'luis@mail.com', 'A', 2, '');
