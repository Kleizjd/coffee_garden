        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="?p=dashboard">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="?p=producto/producto">
                    ...
                    <?php endif; ?><?php if ($_SESSION["rolid"] == 1) : ?>

                        <li class="nav-item">
                            <a class="nav-link" href="?p=categorias/categorias">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-cart">
